...
import {findResultByQuiz, findResultByUser} from "../../redux/service/ResultService";
import { DataGrid } from "@mui/x-data-grid";
import { Button } from "react-bootstrap";
import { GridCellParams } from "@mui/x-data-grid";
import "./showAll.css";

export default function ListResultByUser() {
    ...
    useEffect(() => {
        dispatch(findResultByUser(currentUser.id));
    }, []);
